<?php
    ...
    if(isset($_POST['insert_product'])){
        ...
        or $product_image3==''){
            echo "<script>alert('Please fill all the available')</script>";
            exit();
            ...
            Categoty_id,brand_id,product_image1,product_image2,product_image3,product_price,date,status)
            value('$product_title','$description','$product_keywords','$product_category',
